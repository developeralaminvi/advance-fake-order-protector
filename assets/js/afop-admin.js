...
(function ($) {
    ...
    var AFOP_Admin = {
        ...
        bindEvents: function () {
                        ...
                        if (res.success && res.data) {
                            ...
                            if (isBlocked) {
                                ...
                                if (type === 'phone') {
                                    ...
                                    $matchingBtns.attr('title', 'Click to unblock Phone');
                                } else {
                                    $matchingBtns.find('.afop-btn-icon').html('<i class="fa-solid fa-ban"></i>');
                                    $matchingBtns.find('.afop-btn-text').text('IP Blocked');
                                    $matchingBtns.attr('title', 'Click to unblock IP');
                                }
                            } else {
            ...
            $(document).on('click', '.column-afop_courier_ratio, .column-afop_security_actions, .afop-courier-mini-graph, .afop-order-actions-wrap, .afop-actions-row, .afop-toggle-block-btn, .afop-btn-box, .afop-phone-pill-link, .afop-ip-pill-link, .afop-wa-pill-link, .afop-customer-orders-btn', function (e) {
                e.stopPropagation();
            });
